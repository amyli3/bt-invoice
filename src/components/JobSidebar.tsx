...
interface Props {
  ...
  onHomeClick?: () => void;
  onOpenJobDetails?: (id: number) => void;
}

const InfoIcon = ({ onClick }: { onClick?: (e: React.MouseEvent) => void }) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" style={{flexShrink: 0, cursor: 'pointer'}} onClick={onClick}>
...
export default function JobSidebar({ open, onToggle, selectedJob, onSelectJob, onHomeClick, onOpenJobDetails }: Props) {
