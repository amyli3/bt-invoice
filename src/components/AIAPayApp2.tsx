...
export default function AIAPayApp2({ onNavigate, approvedCOIds, addedCostIds: externalCostIds, onCostIdsChange, addedCOIds: externalCOIds, onCOIdsChange, groupBy: externalGroupBy, onGroupByChange, onOveragesChange }: { onNavigate?: (page: string) => void; approvedCOIds?: string[]; addedCostIds?: string[]; onCostIdsChange?: (ids: string[]) => void; addedCOIds?: string[]; onCOIdsChange?: (ids: string[]) => void; groupBy?: 'estimate' | 'costcode'; onGroupByChange?: (v: 'estimate' | 'costcode') => void; onOveragesChange?: (overages: OverageInfo[]) => void }) {
